        ...
        <section className="flex flex-col gap-20 lg:hidden lg:aria-hidden">
                ...
                <div className="skills-container grid grid-rows-3 grid-cols-2 gap-5">
                    {
                        skillSection.map((item, index) => (
                            <div className="flex flex-col justify-center gap-10 items-center text-primary font-semibold text-shadow-md text-shadow-primary/30 border border-gray-600 rounded-md h-[30vw] text-center p-2" key={index}>
                                {skillIcons[index]}
                                {item}
                            </div>
                        ))
            ...
            <div className="flex flex-col gap-10">
                ...
                <div className="flex flex-col gap-10 border rounded-md border-gray-600 min-h-125 p-5">
                    ...
                    <div className="flex">
                        <p>
                            <a className="flex  items-center gap-2 text-primary font-semibold text-lg" href={projectInformation.projectSource[index]}>
                                View Source
                                <svg className="fill-primary pt-1" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 72 72"><path d="M49.212 51.534L67 35.036L49.212 18.538l-3.789 4.076l10.396 9.641H5v5.562h50.819l-10.396 9.642z"/><path strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="2" d="M49.212 51.534L67 35.036L49.212 18.538l-3.789 4.076l10.396 9.641H5v5.562h50.819l-10.396 9.642z"/></svg>
                            </a>
                        </p>
                    </div>
                </div>
...
function DesktopMain({skillSection, skillIcons, projectInformation, backgroundImage, projectTools, index}: functionProps) {
    return (
        <section className="max-lg:hidden max-lg:aria-hidden flex flex-col gap-20 w-full">
            <div className="flex items-center gap-5">
                <svg className="fill-primary" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 1025 1024"><path d="M896.428 1024h-768q-53 0-90.5-37.5T.428 896V128q0-53 37.5-90.5t90.5-37.5h768q53 0 90.5 37.5t37.5 90.5v768q0 53-37.5 90.5t-90.5 37.5zm-448-960q-27 0-45.5 18.5t-18.5 45.5t18.5 45.5t45 18.5t45.5-18.5t19-45.5t-18.5-45.5t-45.5-18.5zm192 0q-27 0-45.5 18.5t-18.5 45.5t18.5 45.5t45 18.5t45.5-18.5t19-45.5t-18.5-45.5t-45.5-18.5zm192 0q-27 0-45.5 18.5t-18.5 45.5t18.5 45.5t45 18.5t45.5-18.5t19-45.5t-18.5-45.5t-45.5-18.5zm64 256q0-26-19-45t-45-19h-640q-27 0-45.5 19t-18.5 45v512q0 26 18.5 45t45.5 19h640q26 0 45-19t19-45V320zm-160 384h-192q-13 0-22.5-9.5t-9.5-22.5t9.5-22.5t22.5-9.5h192q13 0 22.5 9.5t9.5 22.5t-9.5 22.5t-22.5 9.5zm-299-136l-125 125q-10 10-24 10t-23.5-10t-9.5-23.5t10-22.5l103-103l-103-103q-10-9-10-22.5t9.5-23.5t23.5-10t24 10l125 125q4 4 3 5q7 10 6.5 22t-9.5 21z"/></svg>
                <h1 className="text-gray-300 text-xl font-semibold">Core Competencies</h1>
            </div>

            <div className="skills-container grid grid-rows-2 grid-cols-3 gap-5">
                {
                    skillSection.map((item, index) => (
                        <div className="flex flex-col justify-center gap-10 items-center text-gray-300 bg-mist-900 font-semibold text-shadow-md text-shadow-primary/30 border border-gray-600 rounded-md h-[15vw] text-center p-2" key={index}>
                            {skillIcons[index]}
                            {item}
                        </div>
                    ))
            ...
            <div className="flex flex-col gap-5">
                ...
                <div className="grid grid-cols-[60%_1fr] gap-10">
                    <div className="bg-mist-900 h-min w-full rounded-lg p-2">
                        <div className={`img-container min-h-[25vw] bg-[url(../images/imageStrip.png)] ${backgroundImage[index]} rounded-md bg-size-[600%_auto] bg-no-repeat`}></div>
                    </div>

                    <div className="flex flex-col gap-5 bg-mist-900 p-5 rounded-lg h-min">
                        <div className="flex flex-col gap-5">
                            <h3 className="text-primary text-xl font-semibold">
                                <a href={projectInformation.projectWebsite[index]}>{projectInformation.projectNames[index]}</a>
                            </h3>
                        ...
                        <div className="flex gap-2">
                            <div className="React-Skill rounded-full min-w-20 bg-primary-skill border border-cyan-500 text-center pt-1 pb-1 pl-4 pr-4 text-primary font-medium text-sm">{projectTools[index][0]}</div>
                            <div className="React-Skill rounded-full min-w-20 bg-primary-skill border border-cyan-500 text-center pt-1 pb-1 pl-4 pr-4 text-primary font-medium text-sm">{projectTools[index][1]}</div>
                            <div style={{backgroundColor: projectTools[index][2] === "" ? "mist-900" : "primary-skill", border: projectTools[index][2] === "" ? "mist-900" : "cyan-500"}} key={index} className="React-Skill rounded-full min-w-20 bg-primary-skill border border-cyan-500 text-center pt-1 pb-1 pl-4 pr-4 text-primary font-medium text-sm">{projectTools[index][2]}</div>
                        </div>
                        <div className="flex">
                            <p>
                                <a className="flex  items-center gap-2 text-primary font-semibold text-lg" href={projectInformation.projectSource[index]}>
