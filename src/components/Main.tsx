        ...
        <section className="flex flex-col gap-20 w-full lg:hidden lg:aria-hidden">
            ...
            <div className="flex flex-col gap-10">
                ...
                <div className="flex flex-col gap-10 border rounded-md border-gray-600 min-h-125 p-5">
                    <div className={`img-container min-h-50 bg-[url(../../images/imageStrip.png)] ${backgroundImage[index]} bg-size-[1764px_200px] bg-no-repeat rounded-t-md -m-5`}>
                    </div>
...
export default function Main() {
    ...
    const backgroundImage = ["bg-position-[center_left_-0px]", "bg-position-[center_left_-294px]", "bg-position-[center_left_-588px]", "bg-position-[center_left_-882px]", "bg-position-[center_left_-1176px]", "bg-position-[center_left_-1470px]"];
